    ...
    if age is not None:
        ...
        if age < 1:
            return build_validation_result(
                False,
                "age",
                "An age less than of zero or less is invalid, "
    ...
    if investment_amount is not None:
            ...
            if investment_amount < 5000:
                return build_validation_result(
                    False,
                    "investmentAmount",
                    "The minimum investment amount to use this service is $5,000, "
                    "please provide a larger amount to continue."
                    )
...
def recommend_portfolio(intent_request):
    ...
    initial_recommendation = portfolio_risk(risk_level)
